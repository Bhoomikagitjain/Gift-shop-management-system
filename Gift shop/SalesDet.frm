...
Begin VB.Form SalesDetFrm 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Sales Detalil"
   ClientHeight    =   5625
   ClientLeft      =   3045
   ClientTop       =   2700
   ClientWidth     =   12285
...
Adodc1.RecordSource = "Select * from Sales order by SrNo desc"
Adodc1.Refresh
End Sub
